...
return"function"!=typeof e||e.hasOwnProperty("prototype")});var L=Function.prototype.call;j=O?L.bind(L):function(){return L.apply(L,arguments)};var F={}.propertyIsEnumerable,M=Object.getOwnPropertyDescriptor;o=M&&!F.call({1:2},1)?function(e){var t=M(this,e);return!!t&&t.enumerable}:F;var P={};P=function(e,t){return{enumerable:!(1&e),configurable:!(2&e),writable:!(4&e),value:t}};var x={},T={},I={},H=Function.prototype,q=H.call,N=O&&H.bind.bind(q,q),A={},C=(I=O?N:function(e){return function(){return q.apply(e,arguments)}})({}.toString),D=I("".slice);A=function(e){return D(C(e),8,-1)};var R=Object,z=I("".split);// fallback for non-array-like ES3 and non-enumerable old V8 strings
...
ej=Object.hasOwn||function(e,t){return eF(eO(e),t)};var eM={},eP=0,ex=Math.random(),eT=I(1..toString);eM=function(e){return"Symbol("+(void 0===e?"":e)+")_"+eT(++eP+ex,36)};var eI=k.Symbol,eH=e_("wks"),eq=en?eI.for||eI:eI&&eI.withoutSetter||eM,eN=TypeError,eA=(ej(eH,e="toPrimitive")||(eH[e]=ei&&ej(eI,e)?eI[e]:eq("Symbol."+e)),eH[e]);// `ToPrimitive` abstract operation
// https://tc39.es/ecma262/#sec-toprimitive
J=function(e,t){if(!Y(e)||ee(e))return e;var r,n=ef(e,eA);if(n){if(void 0===t&&(t="default"),r=j(n,e,t),!Y(r)||ee(r))return r;throw new eN("Can't convert object to primitive value")}return void 0===t&&(t="number"),ey(e,t)},// `ToPropertyKey` abstract operation
// https://tc39.es/ecma262/#sec-topropertykey
B=function(e){var t=J(e,"string");return ee(t)?t:t+""};var eC={},eD={},eR=k.document,ez=Y(eR)&&Y(eR.createElement);eD=function(e){return ez?eR.createElement(e):{}},// Thanks to IE8 for its funny defineProperty
...
var eW=Object.getOwnPropertyDescriptor;i=S?eW:function(e,t){if(e=x(e),t=B(t),eC)try{return eW(e,t)}catch(e){}if(ej(e,t))return P(!j(o,e,t),e[t])};var eG={},eU={};// V8 ~ Chrome 36-
...
for(;t.length>i;)ej(n,r=t[i++])&&(~tI(o,r)||tH(o,r));return o};var tq=["constructor","hasOwnProperty","isPrototypeOf","propertyIsEnumerable","toLocaleString","toString","valueOf"].concat("length","prototype");p=Object.getOwnPropertyNames||function(e){return tk(e,tq)},f=Object.getOwnPropertySymbols;var tN=I([].concat);// all object keys, includes non-enumerable and symbols
tw=et("Reflect","ownKeys")||function(e){var t=p(eB(e));return f?tN(t,f(e)):t},t_=function(e,t,r){for(var n=tw(t),o=0;o<n.length;o++){var a=n[o];ej(e,a)||r&&ej(r,a)||c(e,a,i(t,a))}};var tA={},tC=/#|\.prototype\./,tD=function(e,t){var r=tz[tR(e)];return r===tG||r!==tW&&(Q(t)?$(t):!!t)},tR=tD.normalize=function(e){return String(e).replace(tC,".").toLowerCase()},tz=tD.data={},tW=tD.NATIVE="N",tG=tD.POLYFILL="P";tA=tD,/*
...
t3=/(?:ipad|iphone|ipod).*applewebkit/i.test(ea);var t4={};t4="process"===A(k.process);var t7=k.setImmediate,t9=k.clearImmediate,t5=k.process,t8=k.Dispatch,t6=k.Function,re=k.MessageChannel,rt=k.String,rr=0,rn={},ri="onreadystatechange";$(function(){// Deno throws a ReferenceError on `location` access without `--location` flag
...
k.postMessage(rt(e),h.protocol+"//"+h.host)};t7&&t9||(t7=function(e){t1(arguments.length,1);var t=Q(e)?e:t6(e),r=t0(arguments,1);return rn[++rr]=function(){tB(t,void 0,r)},g(rr),rr},t9=function(e){delete rn[e]},t4?g=function(e){t5.nextTick(ra(e))}:t8&&t8.now?g=function(e){t8.now(ra(e))}:re&&!t3?(m=(v=new re).port2,v.port1.onmessage=rs,g=tV(m.postMessage,m)):k.addEventListener&&Q(k.postMessage)&&!k.importScripts&&h&&"file:"!==h.protocol&&!$(rc)?(g=rc,k.addEventListener("message",rs,!1)):g=ri in eD("script")?function(e){tZ.appendChild(eD("script"))[ri]=function(){tZ.removeChild(this),ro(e)}}:function(e){setTimeout(ra(e),0)});var ru=(tU={set:t7,clear:t9}).clear;// `clearImmediate` method
...
w({global:!0,bind:!0,enumerable:!0,forced:k.setImmediate!==rg},{setImmediate:rg});const rv="https://forkify-api.herokuapp.com/api/v2/recipes",rm="343a5345-c1f1-43ce-899a-9fba4bc7155a",ry=function(e){return new Promise(function(t,r){setTimeout(function(){r(Error(`Request took too long! Timeout after ${e} second`))},1e3*e)})},rb=async e=>{try{let t=await Promise.race([fetch(e),ry(10)]),r=await t.json();if(!t.ok)throw Error(`${r.message} ${t.status}`);return r}catch(e){throw e}},r_=async(e,t)=>{try{let r=await Promise.race([fetch(e,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify(t)}),ry(10)]),n=await r.json();if(!r.ok)throw Error(`${n.message} ${r.status}`);return n}catch(e){throw e}},rw={recipe:{},search:{query:"",results:[],page:1,resultsPerPage:10},bookmark:[]},rk=function(e){let{recipe:t}=e.data;return{id:t.id,title:t.title,image:t.image_url,ingredients:t.ingredients,publisher:t.publisher,servings:t.servings,sourceUrl:t.source_url,cookingTime:t.cooking_time,...t.key&&{key:t.key}}},rE=async function(e){try{let t=await rb(`${rv}/${e}?key=${rm}`);rw.recipe=rk(t),rw.bookmark.some(t=>t.id===e)?rw.recipe.bookmarked=!0:rw.recipe.bookmarked=!1}catch(e){throw e}},rS=async function(e){try{rw.search.query=e;let t=await rb(`${rv}?search=${e}&key=${rm}`);rw.search.results=t.data.recipes.map(e=>({id:e.id,title:e.title,image:e.image_url,publisher:e.publisher,...e.key&&{key:e.key}})),rw.search.page=1}catch(e){throw e}},r$=function(e=rw.search.page){rw.search.page=e;let t=(e-1)*rw.search.resultsPerPage,r=e*rw.search.resultsPerPage;return rw.search.results.slice(t,r)},rj=function(e){rw.recipe.ingredients.forEach(t=>{t.quantity=t.quantity*e/rw.recipe.servings}),rw.recipe.servings=e},rO=function(){localStorage.setItem("bookmark",JSON.stringify(rw.bookmark))},rL=function(e){rw.bookmark.push(e),e.id===rw.recipe.id&&(rw.recipe.bookmarked=!0),rO()},rF=function(e){let t=rw.bookmark.findIndex(t=>t.id===e);rw.bookmark.splice(t,1),e===rw.recipe.id&&(rw.recipe.bookmarked=!1),rO()};!function(){let e=localStorage.getItem("bookmark");e&&(rw.bookmark=JSON.parse(e))}();const rM=async function(e){try{let t=Object.entries(e).filter(e=>e[0].startsWith("ingredient")&&""!==e[1]).map(e=>{let t=e[1].replaceAll(" ","").split(",");if(3!==t.length)throw Error("wrong format ! please write correct format.");let[r,n,i]=t;return{quantity:r?+r:null,unit:n,description:i}}),r={title:e.title,image_url:e.image,ingredients:t,publisher:e.publisher,servings:+e.servings,source_url:e.sourceUrl,cooking_time:+e.cookingTime},n=await r_(`${rv}?key=${rm}`,r);rw.recipe=rk(n),rL(rw.recipe)}catch(e){throw e}};var rP={};rP=new URL("icons (1).c14567a0.svg",import.meta.url).toString(),(Fraction=function(e,t){/* double argument invocation */if(void 0!==e&&t)"number"==typeof e&&"number"==typeof t?(this.numerator=e,this.denominator=t):"string"==typeof e&&"string"==typeof t&&(// what are they?
// hmm....
...
},y=Fraction;class rx{_data;_message="No bookmarks yet. Find a nice recipe and bookmark it :)";_errorMsg;render(e,t=!0){if(!e||Array.isArray(e)&&0===e.length)return this.renderError();this._data=e;let r=this._generateMarkup();if(!t)return r;this._clearParenetEle(),this._parentEle.insertAdjacentHTML("afterbegin",r)}updata(e){this._data=e;let t=this._generateMarkup(),r=document.createRange().createContextualFragment(t),n=Array.from(r.querySelectorAll("*")),i=Array.from(this._parentEle.querySelectorAll("*"));console.log(n,i),n.forEach((e,t)=>{let r=i[t];e.isEqualNode(r)||e.firstChild?.nodeValue.trim()===""||(r.textContent=e.textContent),e.isEqualNode(r)||Array.from(e.attributes).forEach(e=>{r.setAttribute(e.name,e.value)})})}_clearParenetEle(){this._parentEle.innerHTML=""}renderSpiner=function(){let e=`
        <div class="spinner">
                <svg>
                  <use href="${/*@__PURE__*/_(rP)}.svg#icon-loader"></use>
                </svg>
              </div>
        `;this._clearParenetEle(),this._parentEle.insertAdjacentHTML("afterbegin",e)};renderError(e=this._errorMsg){let t=`<div class="error">
      <div>
        <svg>
          <use href="${/*@__PURE__*/_(rP)}.svg#icon-alert-triangle"></use>
        </svg>
      </div>
      <p>${e}</p>
    </div>`;this._clearParenetEle(),this._parentEle.insertAdjacentHTML("afterbegin",t)}renderMessage(e=this._message){let t=`<div class="message">
    <div>
      <svg>
        <use href="${/*@__PURE__*/_(rP)}.svg#icon-smile"></use>
      </svg>
    </div>
    <p>
      ${e}
...
`;this._clearParenetEle(),this._parentEle.insertAdjacentHTML("afterbegin",t)}addhandlerRender(e){["hashchange","load"].forEach(t=>window.addEventListener(t,e))}}class rT extends rx{_parentEle=document.querySelector(".recipe");_errorMsg="we could not find that recipe, please try anthor one !";addHandlerUpdateSrvings(e){this._parentEle.addEventListener("click",function(t){let r=t.target.closest(".btn--updata-servings");if(!r)return;let n=+r.dataset.updataTo;n>0&&e(n)})}addHandlerBookmark(e){this._parentEle.addEventListener("click",function(t){let r=t.target.closest(".btn-bookmark");r&&e()})}_generateMarkup(){return` 
        <figure class="recipe__fig">
            ...
            <div class="recipe__details">
              ...
              <div class="recipe__info">
                ...
                <div class="recipe__info-buttons">
                  <button class="btn--tiny btn--updata-servings" data-updata-to="${this._data.servings-1}">
                    <svg>
              ...
              <svg>
              <use href="${/*@__PURE__*/_(rP)}.svg#icon-user"></use>
            </svg>
              </div>
            ...
            <div class="recipe__ingredients">
              ...
              ${this._data.ingredients.map(this._generateMarkupIngradinat).join("")}
        ...
        `}_generateMarkupIngradinat(e){return`
    ...
    `}}var rI=new rT;class rH{_parentEle=document.querySelector(".search");getQuery(){let e=this._parentEle.querySelector(".search__field").value;return this.#e(),e}#e(){return this._parentEle.querySelector(".search__field").value=""}addHandlerSearch(e){this._parentEle.addEventListener("submit",function(t){t.preventDefault(),e()})}}var rq=new rH,rN=new class extends rx{_parentEle="";_generateMarkup(){let e=window.location.hash.slice(1);return`<li class="preview">
  ...
  </li>`}};class rA extends rx{_parentEle=document.querySelector(".results");_errorMsg="no recipes found for your query, please try again";_message="";_generateMarkup(){return console.log(this._data),this._data.map(e=>rN.render(e,!1)).join("")}}var rC=new rA,rD=function(e){var t,r=Object.prototype,n=r.hasOwnProperty,i=Object.defineProperty||function(e,t,r){e[t]=r.value},o="function"==typeof Symbol?Symbol:{},a=o.iterator||"@@iterator",s=o.asyncIterator||"@@asyncIterator",c=o.toStringTag||"@@toStringTag";function u(e,t,r){return Object.defineProperty(e,t,{value:r,enumerable:!0,configurable:!0,writable:!0}),e[t]}try{// IE 8 has a broken Object.defineProperty that only works on DOM objects.
...
(this.arg=t),g}},e}({});try{regeneratorRuntime=rD}catch(e){// This module should not be running in strict mode, so the above
...
"object"==typeof globalThis?globalThis.regeneratorRuntime=rD:Function("r","regeneratorRuntime = r")(rD)}class rR extends rx{_parentEle=document.querySelector(".pagination");addHandlerClick(e){this._parentEle.addEventListener("click",t=>{let r=t.target.closest(".btn--inline");if(!r)return;let n=+r.dataset.goto;console.log(n),e(n)})}_generateMarkup(){let e=this._data.page,t=Math.ceil(this._data.results.length/this._data.resultsPerPage);return(//page 1 and there are other pages
1===e&&t>1?` <button data-goto="${e+1}" class="btn--inline pagination__btn--next">
      <span>Page ${e+1}</span>
      <svg class="search__icon">
        <use href="${/*@__PURE__*/_(rP)}.svg#icon-arrow-right"></use>
      </svg>
    </button>`:e===t&&t>1?`<button data-goto="${e-1}" class="btn--inline pagination__btn--prev">
      <svg class="search__icon">
        <use href="${/*@__PURE__*/_(rP)}.svg#icon-arrow-left"></use>
      </svg>
      <span>Page ${e-1}</span>
    ...
    </button>`:"")}}var rz=new rR;class rW extends rx{_parentEle=document.querySelector(".bookmarks__list");_errorMsg="no bookmarks yet . find a nice recipe and bookmark it ";_message="";addHandlerRender(e){window.addEventListener("load",e)}_generateMarkup(){return console.log(this._data),this._data.map(e=>rN.render(e,!1)).join("")}}var rG=new rW;class rU extends rx{_parentEle=document.querySelector(".upload");_message="Recipe was successfully uploaded";_window=document.querySelector(".add-recipe-window");_overlay=document.querySelector(".overlay");_btnOpen=document.querySelector(".nav__btn--add-recipe");_btnClose=document.querySelector(".btn--close-modal");constructor(){super(),this._addHandlerShowWindow(),this._addHandlerHideWindow()}toggleWindow(){this._overlay.classList.toggle("hidden"),this._window.classList.toggle("hidden")}_addHandlerShowWindow(){this._btnOpen.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerHideWindow(){this._btnClose.addEventListener("click",this.toggleWindow.bind(this)),this._overlay.addEventListener("click",this.toggleWindow.bind(this))}_addHandlerUpload(e){this._parentEle.addEventListener("submit",function(t){t.preventDefault();let r=[...new FormData(this)],n=Object.fromEntries(r);e(n)})}_generateMarkup(){}}var rB=new rU;const rJ=async function(){try{let e=window.location.hash.slice(1);if(!e)return;rI.renderSpiner(),rC.updata(r$()),await rE(e),rI.render(rw.recipe),rG.updata(rw.bookmark)}catch(e){rI.renderError()}},rY=async function(){try{rC.renderSpiner();let e=rq.getQuery();if(await rS(e),!e)return;rC.render(r$()),rz.render(rw.search)}catch(e){throw e}},rQ=async function(e){try{rB.renderSpiner(),await rM(e),rI.render(rw.recipe),rB.renderMessage(),rG.render(rw.bookmark),window.history.pushState(null,"",`#${rw.recipe.id}`),setTimeout(()=>{rB.toggleWindow()},2500)}catch(e){console.error(e),rB.renderError(e.message)}};rG.addHandlerRender(function(){rG.render(rw.bookmark)}),rI.addhandlerRender(rJ),rI.addHandlerUpdateSrvings(function(e){rj(e),rI.updata(rw.recipe)}),rI.addHandlerBookmark(function(){rw.recipe.bookmarked?rF(rw.recipe.id):rL(rw.recipe),rI.updata(rw.recipe),rG.render(rw.bookmark)}),rq.addHandlerSearch(rY),rz.addHandlerClick(function(e){rC.render(r$(e)),rz.render(rw.search)}),rB._addHandlerUpload(rQ);//# sourceMappingURL=index.b9b9d20f.js.map

//# sourceMappingURL=index.b9b9d20f.js.map
